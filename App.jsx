  ...
  return (
    <div style={styles.container}>
      ...
      <header style={styles.header}>
        ...
        <p style={styles.subtitle}>إجابات من المذاهب السنية الأربعة</p>
        <div style={styles.bismillah}>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ</div>
      </header>
      ...
      <main style={styles.main}>
        ...
        <div style={styles.inputSection}>
          <label style={styles.label}>اطرح سؤالك الشرعي</label>
          <textarea
        ...
        {fatwa && (
          <div style={styles.resultsSection}>
            ...
            <div style={styles.questionDisplay}>
              ...
              <span style={styles.questionText}>{fatwa.question}</span>
            </div>
                ...
                >
                  ...
                  >
                    <div style={styles.madhhabTitleRow}>
                      <span style={styles.madhhabIcon}>{madhhabInfo[madhhab].icon}</span>
                      <div>
                        <h3 style={styles.madhhabName}>{madhhabInfo[madhhab].name}</h3>
                        <p style={styles.founderName}>{madhhabInfo[madhhab].founder}</p>
                      </div>
                    </div>
                  ...
                  <div style={{
                    ...
                    <span style={styles.rulingLabel}>الحكم:</span>
                    <span style={{
                      ...styles.rulingText,
                      color: madhhabColors[madhhab].bg
                    }}>
                  ...
                  {expandedMadhhab === madhhab && (
                    <div style={styles.expandedContent}>
                      <div style={styles.section}>
                        <h4 style={styles.sectionTitle}>📜 الشرح والتفصيل</h4>
                        <p style={styles.sectionText}>{fatwa[madhhab]?.explanation}</p>
                      </div>
                      {fatwa[madhhab]?.evidence && (
                        <div style={{
                          ...
                          <h4 style={styles.evidenceTitle}>📖 الدليل</h4>
                          <p style={styles.evidenceText}>{fatwa[madhhab]?.evidence}</p>
                        </div>
                      )}
                    </div>
                  )}
            ...
            {fatwa.consensus && (
              <div style={styles.consensusBox}>
                ...
                <p style={styles.consensusText}>{fatwa.consensus}</p>
              </div>
            )}
            ...
            {fatwa.note && (
              <div style={styles.noteBox}>
                <h3 style={styles.noteTitle}>💡 ملاحظة</h3>
                <p style={styles.noteText}>{fatwa.note}</p>
              </div>
            )}
          </div>
        )}
        ...
        <div style={styles.disclaimer}>
          <p>⚠️ هذا التطبيق للإرشاد العام فقط. للمسائل الخاصة، يُرجى الرجوع إلى أهل العلم المتخصصين.</p>
        </div>
      </main>
...
const styles = {
  ...
  headerPattern: {
    ...
    right: 0,
    bottom: 0,
    backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0L60 30L30 60L0 30L30 0z' fill='%23ffffff' fill-opacity='0.05'/%3E%3C/svg%3E")`,
  ...
  button: {
    ...
    boxShadow: '0 4px 10px rgba(26,95,74,0.3)'
  },
  loadingText: {
    display: 'flex',
    alignItems: 'center',
